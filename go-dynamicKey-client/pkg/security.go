...
// ReqDecode decrypt by dynamics security key
...
//decodeAesBase64ByDynamics base64+aes128 decrypt by dynamics security key
...
func encodeAesBase64(src string) (string, error) {
    //aes128
    s1, err := encodeAesCbc(src)
    if err != nil {
...
func encodeAesCbc(src string) ([]byte, error) {
    ...
    blockMode := cipher.NewCBCEncrypter(block, []byte(REQ_IV))
